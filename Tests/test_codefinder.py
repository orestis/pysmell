...
from pysmell.codefinder import CodeFinder, getClassAndParents, getNames, ModuleDict, findPackage, getSafeTree
...
class InferencingTest(unittest.TestCase):
    ...
    def testGetNames(self):
        ...
        self.assertEquals(getNames(getSafeTree(source, 3)), expectedNames)
